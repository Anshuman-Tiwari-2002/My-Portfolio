...
const Header: React.FC = () => {
  ...
  return (
    <section id="header" className="relative min-h-[92vh] overflow-hidden py-22 sm:py-26 lg:py-30">
      ...
      <div className="mx-auto grid min-h-[calc(92vh-10rem)] max-w-6xl items-center gap-10 lg:grid-cols-[1.06fr_0.94fr]">
        <div className="order-2 flex flex-col items-start lg:order-1">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3 text-sm text-subtle">
            ...
            <span className="rounded-full border border-border bg-surface/60 px-3 py-1.5 shadow-ring backdrop-blur">{hero.title}</span>
          </div>
          ...
          <div className="mt-1 flex flex-wrap items-center gap-3">
            <a href={links.linkedin} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-muted transition hover:text-accent-strong">
              <FaLinkedinIn />
              LinkedIn
            </a>
            <a href={links.github} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-muted transition hover:text-accent-strong">
              <FaGithub />
              GitHub
            </a>
          </div>
        ...
        <div className="order-1 mx-auto lg:order-2">
          <div className="relative rounded-[2rem] border border-border bg-surface/70 p-3 shadow-soft backdrop-blur">
            ...
            <NoSSR>
              <PhotoWall size={width > Breakpoints.lg ? 410 : width > Breakpoints.sm ? 340 : 260} />
            </NoSSR>
            <div className="mt-3 rounded-[1.25rem] border border-border bg-app/60 p-4 shadow-ring backdrop-blur">
              ...
              <p className="mt-2 text-sm leading-6 text-muted">
                Software Engineer at Sophize, focused on Next.js, React Flow, TypeScript, and Node.js REST APIs.
              </p>
            </div>
          </div>
          <Profiles />
